...
import { getNotification, markNotificationAsRead } from "@/action/notification.action";
          ...
          <ScrollArea className="h-[calc(100vh-12rem)]">
            {notifications.length === 0 ? (
              ...
              notifications.map((notification) => (
                <article
                aria-label={`${notification.creator.name ?? notification.creator.username} ${notification.type.toLowerCase()}`}
                  key={notification.id}
